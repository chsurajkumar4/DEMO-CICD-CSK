...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="flightbooking-airflow-1")
    bq_project = Variable.get("bq_project", default_var="polar-land-475613-c9")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"flight-data/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/flight-data/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "94314683849-compute@developer.gserviceaccount.com",
                "network_uri": "projects/polar-land-475613-c9/global/networks/default",
                "subnetwork_uri": "projects/polar-land-475613-c9/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="polar-land-475613-c9",
        region="us-central1",
